...
async def ask_question(question: str = Form(..., title="User Question"),file: UploadFile = File(None)):
    ...
    try:
        ...
        functions_with_file = ["q8_extract_csv", "q9_json_sort", "q15_date_size", "q16_mv_rename", "q17_identical_lines", "q20_image_compress", "q22_google_colab", "q23_pixels_brightness", "q30_token_count", "q32_extract_text","q53_json_sales", "q48_margin", "q51_apache_get", "q52_apache_bytes", "q54_key_count",  "q57_reconstruct_image"]
