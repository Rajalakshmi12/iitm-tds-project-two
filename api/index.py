...
async def ask_question(question: str = Form(..., title="User Question"),file: UploadFile = File(None)):
    ...
    try:
        ...
        functions_with_file = ["q8_extract_csv", "q9_json_sort", "q20_image_compress","q23_pixels_brightness", "q30_token_count", "q32_extract_text","q53_json_sales", "q54_key_count",  "q57_reconstruct_image"]
